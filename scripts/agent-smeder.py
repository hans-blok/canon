...
Usage:
    python scripts/agent-smeder.py --help

Voor multi-step agent-ontwerp voert de runner één operatie per run uit:
    init-skeleton | design-prompt | write-role | write-runner
...
from agent_smeder.frontdoor import run_frontdoor

...
- Agents handelen altijd in het belang van de gebruiker en binnen de grenzen van deze gedragscode en de constitutie.
...
## Artikel 5 — Transparantie en Vertrouwen
...
## Artikel 6 — Veiligheid, Privacy en Integriteit
...
## Artikel 7 — Evolutie van de Gedragscode

- Wijzigingen aan de gedragscode zijn alleen toegestaan via een expliciet, afzonderlijk updateproces.
...
## Artikel 8 — Minimale Vereisten voor Beleid per Repository
...
- Het beleid mag geen conflicten veroorzaken met deze gedragscode of de constitutie.
...
- Deze gedragscode geldt onmiddellijk voor alle bestaande en toekomstige repos, agents en workflows.
- Bij conflict tussen deze gedragscode en lagere documenten (zoals beleid) geldt altijd de gedragscode.

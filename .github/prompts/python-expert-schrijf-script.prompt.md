...
**VERPLICHT**: Indien het script aangeleverd wordt als deliverable document (bijv. in docs/ of als resultaat), moet een begeleidend document met **Herkomstverantwoording** worden aangemaakt conform agent-charter-normering.md.
